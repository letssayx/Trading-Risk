...
def verify_ui():
    with sync_playwright() as p:
        ...
        # Let's see what the HTML actually is
        print("Taking a snapshot of the current state before finding tabs...")
        page.screenshot(path="/home/jules/verification/debug.png")

        print("Clicking Dividends Data Bank tab...")
        # Since locator is timing out, maybe the div isn't there or is hidden. Let's just use JS to force show the div
        page.evaluate("""
