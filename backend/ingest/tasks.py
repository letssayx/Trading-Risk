    ...
    try:
        ...
        for r in ca_records:
            ...
            if r.dividend_type in ['Bonus', 'Split', 'Demerger']:
                ...
                # Force reparse if requested to heal historical data gaps
                parsed_amt = r.parsed_dividend_amount
                if force and not parsed_amt and r.purpose:
                    from backend.ingest.field_mapper import FieldMapper
                    parsed_amt, _ = FieldMapper._parse_dividend(r.purpose)
