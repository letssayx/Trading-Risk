                    ...
                    if 'dividend' in purpose or 'dividend' in desc:
                        ...
                        if symbol and symbol in symbol_ca_map:
                            ...
                            for ca in symbol_ca_map[symbol]:
                                ...
                                _clean_subject = re.sub(r'(?:face value|fv)\s*(?:of\s*)?(?:rs\.?|re\.?|rupees?|inr|[-/]|\s)*\d+(?:\.\d+)?', '', subject, flags=re.IGNORECASE)
                                ...
                                try:
                                    ...
                                    if bm_date_obj and abs((ann_date_obj - bm_date_obj).days) <= 10:
                                        ...
                                        if found_amount is None:
                                            _clean_text = re.sub(r'(?:face value|fv)\s*(?:of\s*)?(?:rs\.?|re\.?|rupees?|inr|[-/]|\s)*\d+(?:\.\d+)?', '', attchmntText, flags=re.IGNORECASE)
                        ...
                        if found_amount is None:
                            ...
                            _clean_text_2 = re.sub(r'(?:face value|fv)\s*(?:of\s*)?(?:rs\.?|re\.?|rupees?|inr|[-/]|\s)*\d+(?:\.\d+)?', '', text_to_search, flags=re.IGNORECASE)
