...
class GeminiInterface:
    ...
    def translate_query(self, user_query: str) -> str:
        ...
        if "risk" in user_query.lower() and "unwind" in user_query.lower():
            return """
from backend.domain.risk.standard_scenarios import SCENARIO_PRICE_DOWN_10
...
"""
             ...
             return """
from backend.ideas.generation.engine import generate_trade_ideas
from backend.ideas.explanations.narrative import compose_narrative
