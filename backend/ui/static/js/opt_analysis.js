...
async function loadOptionsAnalysis() {
    ...
    try {
        ...
        const option = {
            ...
            grid: [
                { left: '5%', right: '55%', bottom: '5%', top: '10%' }, // Left side (Call OI)
                { left: '55%', right: '5%', bottom: '5%', top: '10%' }  // Right side (Put OI)
            ],
            xAxis: [
                {
                    type: 'value',
            ...
            yAxis: [
                {
                    ...
                    data: strikes,
                    position: 'right',
                    axisLabel: { show: true, color: '#FFCC00', fontWeight: 'bold', margin: 38, align: 'center' },
                    axisLine: { show: false },
                    axisTick: { show: false }
                },
                {
