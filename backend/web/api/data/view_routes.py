            ...
            if data and isinstance(data, list):
                ...
                if xbrl_url:
                    ...
                    if res_xml.status_code == 200:
                        ...
                        if total_out > 0:
                            # Calculate public/others as the remainder to ensure exact summation
                            public_gt_200k = total_out - (promoter + fii + dii + retail_less_200k)
                            # Ensure no negative values due to parsing weirdness
                            ...
                            return {
                                ...
                                "fii_shares": fii,
                                "dii_shares": dii,
                                "retail_shares": retail_less_200k,
                                "public_shares": public_gt_200k
                            }

        # If we reach here, it failed to import from NSE
        raise Exception("Failed to fetch or parse XBRL data from NSE")
