...
from backend.web.api.data import view_routes, derivatives_routes, special_sit_routes, board_meeting_routes
...
app.include_router(board_meeting_routes.router, prefix="/api/data/board-meetings", tags=["data"])
