...
# We need to make sure the indentation matches the original `return process_results(results, model)`
content = re.sub(
    r"\n        if type == 'mwpl':",
    r"\n            if type == 'mwpl':",
    content
...
# And fix all the other lines in that block by adding 4 spaces
block = """            from collections import defaultdict
