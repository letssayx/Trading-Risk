...
def verify_feature(page: Page):
    ...
    print("Executing switchMainTab via JS directly on window...")
    # Directly inject into the global window object to force it
    page.evaluate("window.switchMainTab('dividends')")
